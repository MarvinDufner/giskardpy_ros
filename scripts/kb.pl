...
canExecute_envJointGoal(Motion, Joint, GoalState, Handle, Gripper, Feedback) :- add_init_pose(), execute(),
                                                                                add_open_container(Motion, Joint,
                                                                                GoalState, Handle, Gripper),
                                                                                giskard_project_eval(Feedback).
...
causes(Motion, StateChange, MotionParam, Feedback) :- motion_effect(Motion, StateChange),
                                            (
...
canPerform(Robot, Motion, MotionParam, Feedback) :- robot(Robot),
                                          ...
                                          canExecute_envJointGoal(Motion, Joint, GoalState, Handle, Gripper, Feedback).
